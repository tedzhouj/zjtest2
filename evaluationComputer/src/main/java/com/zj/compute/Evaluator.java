...
import com.zj.compute.function.FunctionGroup;
import com.zj.compute.function.FunctionResult;
import com.zj.compute.math.MathFunctions;
import com.zj.compute.operator.AdditionOperator;
import com.zj.compute.operator.BooleanAndOperator;
import com.zj.compute.operator.BooleanNotOperator;
import com.zj.compute.operator.BooleanOrOperator;
import com.zj.compute.operator.ClosedParenthesesOperator;
import com.zj.compute.operator.DivisionOperator;
import com.zj.compute.operator.EqualOperator;
import com.zj.compute.operator.GreaterThanOperator;
import com.zj.compute.operator.GreaterThanOrEqualOperator;
import com.zj.compute.operator.LessThanOperator;
import com.zj.compute.operator.LessThanOrEqualOperator;
import com.zj.compute.operator.ModulusOperator;
import com.zj.compute.operator.MultiplicationOperator;
import com.zj.compute.operator.NotEqualOperator;
import com.zj.compute.operator.OpenParenthesesOperator;
import com.zj.compute.operator.Operator;
import com.zj.compute.operator.SubtractionOperator;
 ...
 * 可以支持以下表达式:<br>
 * <ul>
 * <li><i>代数式</i> Expression involving numbers. Numbers are treated
 * as doubles, so resulting numbers will contain at least one decimal place.</li>
 * <li><i>布尔式</i> Expression that evaluate to true (1.0) and false (0.0).</li>
 * <li><i>方程式</i> Custom functions can be created or there are many
...
public class Evaluator {
	 ...
	 */
	public Evaluator() {
		this(EvaluationConstants.SINGLE_QUOTE, true, true, false, true);
	}
